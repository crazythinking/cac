...
public interface PaymentPlanService {
	 ...
	 * @param it 利率表
	 * @param loanFeeMethod 手续费收取方式
	 * @param loanFeeCalcMethod 手续费计算方式
	 * @param feeAmount 手续费金额
	 * @param feeRate 手续费费率
	 * @param postDate 入账日期
	 * @param pmtDueDays 到期还款天数
	 * @return
	 */
	public PaymentPlan regPaymentPlan(Integer totalPeriod, Interval interval, Integer mult, PaymentMethod paymentMethod, BigDecimal loanAmount, InterestTable it, LoanFeeMethod loanFeeMethod, CalcMethod loanFeeCalcMethod, BigDecimal feeAmount, BigDecimal feeRate, Date postDate, int pmtDueDays);
	 ...
	 * @param postDate 入账日期
	 * @param pmtDueDays 到期还款天数
	 * @param intFirstPeriodAdj 首期天数调整 
	 * @return
	 */
	public PaymentPlan regPaymentPlan(Integer totalPeriod, Interval interval, Integer mult, PaymentMethod paymentMethod, BigDecimal loanAmount, InterestTable it, LoanFeeMethod loanFeeMethod, CalcMethod loanFeeCalcMethod, BigDecimal feeAmount, BigDecimal feeRate, Date postDate, int pmtDueDays, Boolean intFirstPeriodAdj);
	
	/**
	 * 保存还款计划
	 * @param acctSeq 贷款序列号
	 * @param custId 客户编号
	 * @param acctParamId 贷款参数编号
	 * @param plan 还款计划
	 * @param saveDate 保存日期
	 */
	 ...
	 * @return
	 */
	public PaymentPlan regPaymentPlan(Integer totalPeriod, Interval interval, Integer mult, PaymentMethod paymentMethod, BigDecimal loanAmount, InterestTable it, LoanFeeMethod loanFeeMethod, CalcMethod loanFeeCalcMethod, BigDecimal feeAmount, BigDecimal feeRate, Date postDate, int pmtDueDays , Integer acctSeq);
